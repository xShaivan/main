...
=== Use case: Viewing a patient’s appointments: `viewappt`
Assume that user has already requested the System to display a list of patients.

*MSS*

1.  User requests to view an appointment in the patient’s timetable.
2.  System displays the details of the specified appointment in the patient’s timetable.
+
Use case ends.
...
[none]
* 1c. User requests to view an appointment that does not exist for the specified patient.
+
[none]
** 1c1. System shows message that the patient does not have an appointment with the start date and time that the user is requesting to view.
+
Use case ends.
...
+
[none]
** 1d1. System shows message that the patient does not have an appointment with the start date and time that the user is requesting to edit.
+
Use case ends.
...
+
[none]
** 1c1. System shows message that the patient does not have an appointment with the start date and time that the user is requesting to delete.
+
Use case ends.
