...
+
[none]
** 1c1. System shows an error message that the end time for an appointment needs to be after the start time.
+
Use case ends.
...
+
[none]
** 1c1. System shows message that the patient does not have an appointment with the start date and time that the user is requesting.
+
Use case ends.
