...
image::AddApptSequenceDiagram.png[width="750"]

The following activity diagram shows how the addappt operation works:

.Activity diagram for add appt operation
image::AddApptActivityDiagram.png[width="750"]
