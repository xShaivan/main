...
+
[none]
** 1a1. System gives user an example on the correct format of adding a patient.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of editing a patient.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of finding a patient.
+
Use case ends.
...
1.  User requests to add an entry into patient’s timetable.
2.  System adds the entry into patient’s timetable and displays a message that the addition is successful.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of adding appointment.
+
Use case ends.
...
[none]
* 1c. Patient’s timetable already has an entry which overlaps with the new entry in terms of timing.
+
[none]
** 1c1. System shows an error message that there is an overlapped entry, and shows both the entries which overlap each other.
+
Use case ends.
...
1.  User requests to view all entries in the patient’s timetable.
2.  System displays all entries in the patient’s timetable.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of viewing appointments.
+
Use case ends.
...
1.  User requests to edit an entry in the patient’s timetable with new details.
2.  System updates the entry in the patient’s timetable with the new details and displays a message that edit is successful.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of editing appointment.
+
Use case ends.
...
1.  User requests to delete an entry in the patient’s timetable.
2.  System deletes the entry in the patient’s timetable and displays a message that deletion is successful.
+
Use case ends.
...
+
[none]
** 1a1. System gives user an example on the correct format of deleting appointment.
+
Use case ends.
