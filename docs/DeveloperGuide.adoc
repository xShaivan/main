...
|`* * *` |doctor |add a list of medical reports for every patient |refer to them in the future
...
+
[none]
** 1a1. System shows an error message that the format is wrong and gives user an example on the correct format of viewing appointments.
+
Use case ends.
...
+
[none]
** 1c1. System shows an error message that the patient does not have an appointment with the start date and time that the user is requesting to view.
+
Use case ends.
