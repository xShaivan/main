...
* *`shadowJar`* +
Creates the `healthbook.jar` file in the `build/jar` folder, _if the current file is outdated_. +
e.g. `./gradlew shadowJar`

****
To force Gradle to create the JAR file even if the current one is up-to-reportDate, you can '`clean`' first. +
