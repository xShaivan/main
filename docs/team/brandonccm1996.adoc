...
** Justification: This feature improves the product significantly because the user can schedule and track his patients' appointments easily and make sure that there are no scheduling clashes, and thus can remind his patients in advance that they have appointments.
