...
|===
|_This section documents my main contributions to the Health Book application. This showcases my ability to write functional and test code to enhance an application, and to manage a project and perform in a team setting._
|===
