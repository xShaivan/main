...
* an *encryption feature* to keep patients' data secure
...
|===
|_This section is a summary of my main contributions to the Health Book application. This showcases my ability to write code to enhance an application and test application features, as well as my ability to manage a project and perform in a team setting.
|===

* *Major enhancement*: incorporated a feature to *add, view, edit and delete appointments for a patient*
** What it does: allows the user to manage appointments for patients.
...
** What it does: allows the user to see the information pertaining to his selected patient in the information panel
