...
.The main features of HealthBook includes:
|===
|Feature |Description
...
Their usages can be found in the user guide: https://cs2113-ay1819s1-t12-2.github.io/main/UserGuide.html[Click Here]
