...
* `find hsa/ alcohol`
Returns any patient who is allergic to alcohol.
* `find i/ high cholesterol`
Returns any patient whose first medical report information contains high cholesterol.
...
e.g. `find hsa/ alcohol` +
e.g. `find i/ high cholesterol`
* *Delete* : `delete INDEX` +
e.g. `delete 2`
