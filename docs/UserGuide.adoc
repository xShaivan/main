...
.Image of GUI after adding an appointment to a patient with no existing appointments
...
.Image of GUI after adding an appointment to a patient with existing appointments
