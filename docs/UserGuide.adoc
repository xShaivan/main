...
For patient in index 2, populate NRIC field with S91234567A, reportDate of birth field
...
For patient in index 2, edit NRIC field with S91234567A, reportDate of birth field with
...
Edits title, reportDate and information of existing medical report at index 1 for patient at index 3 titled DEPRESSION, dated 02-01-2018 with the report stating that the patient has been diagnosed with depression and is prescribed XXX medicine. Next appointment on 03-02-2018.
