...
* `editreport 3 ot/Asthma od/01-01-2018 t/Depression d/02-02-2018 i/Prescribed XXX medicine, next appointment on 03-03-2018.` +
Edits title, date and information of existing medical report titled Asthma and dated 01-01-2018 for patient at index 3.
// end::reportcommands[]
