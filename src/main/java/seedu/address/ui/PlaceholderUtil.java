...
public class PlaceholderUtil {
    public static final String DATA_PROTECTION_NOTICE_TEXT = "DATA PROTECTION NOTICE\n"
            ...
            + "21. This Notice applies in conjunction with any other notices, contractual clauses and consent\n"
            + "clauses that apply in relation to the collection, use and disclosure of your personal data by us.\n"
            + "22. We may revise this Notice from time to time without any prior notice. You may determine if\n"
