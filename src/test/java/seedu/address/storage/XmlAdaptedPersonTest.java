...
public class XmlAdaptedPersonTest {
    ...
    private static final List<XmlAdaptedTag> VALID_TAGS = BENSON.getTags().stream()
            ...
            .collect(Collectors.toList());
    private static final List<XmlAdaptedMedHistory> VALID_MEDHISTORY = BENSON.getMedHistory().stream()
            .map(XmlAdaptedMedHistory::new)
            .collect(Collectors.toList());
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        XmlAdaptedPerson person = new XmlAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REPORTS, VALID_MEDHISTORY, VALID_APPTS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        XmlAdaptedPerson person = new XmlAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                VALID_REPORTS, VALID_MEDHISTORY, VALID_APPTS, invalidTags);
